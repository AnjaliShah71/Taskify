...
import 'package:doable_todo_list_app/screens/register_page.dart';
...
Future<void> main() async {
  ...
  // ✅ ADD THIS — check karo user pehle se logged in hai ya nahi
  ...
  runApp(DoableApp(isLoggedIn: isLoggedIn));
  //runApp(const DoableApp());
}

class DoableApp extends StatefulWidget {
  final bool isLoggedIn;
  const DoableApp({super.key, required this.isLoggedIn});
