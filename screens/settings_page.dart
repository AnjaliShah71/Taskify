  ...
  Future<void> _handleLogout() async {
    ...
    final confirm = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text('You want to logout from app'),
        actions: [
          TextButton(
    ...
    // SharedPreferences mein is_logged_in = false save karo
    final prefs = await SharedPreferences.getInstance();
    await prefs.setBool('is_logged_in', false);

    if (!mounted) return;

    // Login page pe jao — back press se wapas na aaye isliye removeUntil
      ...
      body: SafeArea(
        child: _loading
          ...
          children: [
            ...
            const SizedBox(height: 12), // ✅ ADD THIS — logout ke liye thoda space
